class ReliabilityStation:
    ...
    pct_temps_vide : float
    pct_temps_sature : float
    """
    def __init__(self, station_id, timestamp, score_fiabilite,
                 taux_remplissage_moyen, pct_temps_vide, pct_temps_sature):
